...
Worker ID: 81202f24 | Label: RESEARCH: P-GOV L3 "CLUSTER INVESTIGATION [undefined-GOV]: 23 GOV items for undefined. Items: [1] e001: No description (source: ?, info: ?);" | Role: Specialist Worker
...
## Ralph Signaling (Worker ID: 81202f24)

Signal progress regularly so your commander knows you're alive:
```bash
curl -s -X POST http://localhost:38007/api/ralph/signal/by-worker/81202f24 -H "Content-Type: application/json" -d '{"status":"in_progress","progress":50,"currentStep":"describing what you are doing now"}'
```
...
| My siblings | GET | `/api/workers/81202f24/siblings` |
| My children | GET | `/api/workers/81202f24/children` |
...
Spawn body: `{"template":"TYPE","label":"NAME","projectPath":"/home/druzy/thea/researchlab-release","parentWorkerId":"81202f24","task":{"description":"..."}}`
...
**Spawn >60s tasks. Check siblings first. Include parentWorkerId: "81202f24" in ALL spawns.**

## Work Practices

- Git commit frequently. Uncommitted work is LOST when workers are terminated.
- Check running siblings before spawning: `curl -s http://localhost:38007/api/workers/81202f24/siblings`
