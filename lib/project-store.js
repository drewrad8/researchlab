...
function create(topic, opts) {
  ...
  const project = {
    ...
    status: 'pending',
    phase: null,
    investigationBudget: opts?.investigationBudget != null ? opts.investigationBudget : 10,
...
module.exports = { create, getAll, get, update, remove, getGraph, pause, unpause, PROJECTS_DIR };
